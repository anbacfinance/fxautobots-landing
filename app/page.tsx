...
function TestimonialCarousel() {
  const testimonials = [
    ...
    },
    {
      ...
      review: "Venía probando otras cosas y con FXAutoBots sentí una propuesta más clara y ordenada.",
      location: "Chile",
    },
    {
      name: "Javier R.",
      image: "https://randomuser.me/api/portraits/men/22.jpg",
      review: "La configuración fue más fácil de lo que esperaba. En poco tiempo ya lo tenía funcionando.",
      location: "Perú",
    },
    {
      name: "Lucía M.",
      image: "https://randomuser.me/api/portraits/women/28.jpg",
      review: "Me gustó que explican bien cada bot y que no te venden humo. Todo bastante claro.",
      location: "Uruguay",
    },
    {
      name: "Fernando T.",
      image: "https://randomuser.me/api/portraits/men/41.jpg",
      review: "Uso Deus como parte de mi operativa y me sirve para mantener disciplina y reglas definidas.",
      location: "Paraguay",
    },
    {
      name: "Camila V.",
    ...
    },
    {
      ...
      review: "Me ayudó a ordenar mi operativa y a no entrar por impulso como hacía antes.",
      location: "Chile",
    },
    {
      name: "Andrés P.",
            ...
            {slide === 1 && (
              <>
                <div className="space-y-4">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Replica automáticamente nuestras operaciones en tu cuenta. Deus Copy <span className="text-green-500 font-semibold">+40%</span>
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 pt-2">
                  ...
                  <div className="flex gap-4 pt-2">
                    {[
                      { label: "Deus Copy", value: "+40%", color: "text-green-500" },
                ...
                <div className="relative h-[350px] lg:h-[450px] rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-orange-500/10 to-red-500/5 border border-orange-500/20 flex items-center justify-center">
                  ...
                  <div className="w-full px-6 space-y-4">
                    {[
                      { name: "Deus Copy", profit: "+40%", dd: "2.88%", min: "$30", color: "emerald", badge: "Conservador" },
                    ].map((s) => (
        ...
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
          ...
          <div className="flex flex-wrap justify-center md:justify-end gap-4 items-center">
            ...
            <div className="flex items-center gap-4 ml-2">
              ...
              <a href="https://t.me/fxautobots_bot" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-all hover:scale-110"><MessageCircle className="h-5 w-5" /></a>
            </div>
          </div>
        </div>
      </footer>
