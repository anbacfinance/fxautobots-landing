...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Los rendimientos varían según el mercado. Deus Copy lleva actualmente +32.30% de profit con un drawdown máximo de 1.87%. Rendimientos pasados no garantizan resultados futuros.",
  },
  {
